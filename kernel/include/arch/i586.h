...
struct i586_regs_t {
  uint32_t edi, esi, ebp, esp, ebx, edx, ecx, eax, eip, cs, flags;
...
extern void i586_switch(uint32_t eax, const void *edi);
...
extern void i586_loop(void);

extern void i586_lidt(const void *edi);

extern uint32_t i586_int16(uint8_t id, i586_regs_t *regs);
